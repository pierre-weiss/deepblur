...
"""
# See https://github.com/khammernik/sigmanet/blob/master/reconstruction/common/mytorch/models/didn.py
...
class DIDN(nn.Module):
    ...
    def __init__(self, in_chans, out_chans, num_chans=32,
                 pad_data=True, global_residual=True, n_res_blocks=3, bias=False):
        super().__init__()
